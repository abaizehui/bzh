...
public class BzhWxApiServiceImpl implements IBzhWxApiService
{
    ...
    public String getQrCode(BzhQrCodeReq bzhQrCodeReq) {
        ...
        try {
            ...
            IOUtils.write(bytes, FileUtils.newOutputStream(new File(qrCodePath + "/" + qrCodeName),true));
            String pathFileName = FileUploadUtils.getPathFileName(qrCodePath, qrCodeName);
